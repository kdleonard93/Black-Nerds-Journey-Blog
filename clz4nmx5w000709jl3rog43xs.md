...
If you have any sort of Git GUI, all you need to do is take a look at the plethora of commits on `master` when I was trying to get this deployed for the 1st time ([Screenshot](https://www.loom.com/i/dc0612b7c12643b696e84161c7236f03)). I was ready to buy some HIMs Hair Growth Snake Oil and grow a few more strings of hair just to pull them out again. Eventually, I finally figured out that I needed a few adjustments to my settings file, change how I was serving up my static files for production, and (as mentioned earlier) learned that Postgres will be needed for the production database setup. Render's doc only explains how to switch DBs to a basic setup of Postgres, so configuring it to work how I needed took a little extra leg work. But all was figured out and here are the main takeaways:
